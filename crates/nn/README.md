...
Layers: convolutions, RNNs, transformers, attention, MoE blocks, and serving-oriented helpers (`ServingEngine`, continuous batching, KV cache—**library** primitives; for an HTTP process see [`rustral-inference-server`](../inference-server/README.md)).
